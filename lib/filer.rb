module Filer
  ...
  #
  # @param result
  # @param doc_id [Decimal]
  # @param docname [String]
  # @param doclink
  # @param user_id [Decimal]
  # @return [Symbol, String] 'The file was successfully added to the database.' if the file was successfully parsed,
  # 	or 'An error occurred while parsing the Google Doc.' if the file was not parsed
  ...
  # Compiles the file snippets
  #
  # @param doc_id [Decimal] if of the document to be compiled into snippets
  # @return [Symbol, String] "Successfully compiled snippets." if the file was successfully compiles,
  # 	or "An error occurred:' if the file was not compiled
